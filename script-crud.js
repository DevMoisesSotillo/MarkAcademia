...
const btRemoverConcluida = document.querySelector('#btn-remover-concluidas')
...
function criarElementoTarefa(tarefa) {
    ...
    botao.onclick = () => {
        ...
        //console.log('Nova Descriçao de Tarefa:' , novaDescricao)
        if (novaDescricao) {
...
document.addEventListener('focoFinalizado', () => {
    if (tarefaSelecionada && litTarefaSelecionada){
        ...
        litTarefaSelecionada.querySelector('button').setAttribute('disabled' , 'disabled')
...
btRemoverConcluida.onclick = () => removerTarefas(true)
